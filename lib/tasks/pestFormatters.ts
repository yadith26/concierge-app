...
export function formatPestDateShort(date: string, locale: string) {
...
export function formatPestDateLong(date: string, locale: string) {
  return formatDate(`${date}T12:00:00`, locale, {
    day: 'numeric',
    month: 'long',
    year: 'numeric',
...
export function formatPestDateTime(value: string, locale: string) {
